...
public class NestedFrameTest extends IHGDropDownTest {

	
	@Test(dependsOnMethods= {"dropdown2"})//first parent class method will execute and then child class method going to execute
	public void Frame()
	{
